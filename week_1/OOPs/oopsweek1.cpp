...
public:
    ...
    {
        if (age < 12)
            cout << "You have successfully registered  as Kids Account" << endl;
        else
...
public:
    ...
    {
        if (age > 12)
            cout << "You have successfully registered as Adult Account" << endl;
        else
